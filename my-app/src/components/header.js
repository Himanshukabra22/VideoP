            ...
            </View>
            {
                profileImg === '' ?
                    <View style={styles.AuthContainer}>
                        ...
                        <TouchableOpacity activeOpacity={0.5} style={styles.AuthButton}>
...
const styles = StyleSheet.create({
    container: {
        ...
        flexDirection: 'row',
        paddingLeft: Platform.IS_LARGE_SCREEN ? 20 : width / 40,
        paddingHorizontal: Platform.IS_LARGE_SCREEN ? 5 : width / 40,
        zIndex: 1,
    },
    websiteNameBox: {
        flexDirection: 'row',
